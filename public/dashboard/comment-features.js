...
// Enables database-backed likes and replies for comments
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.addReply = function (commentIndex) {
        console.log('addReply called for index:', commentIndex);
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div id="replyForm-${index}" class="hidden mt-3 pl-4 border-l-2 border-gray-300">
                        ...
                        <div class="flex justify-end gap-2 mt-2">
                            <button onclick="toggleReplyForm(${index})" class="px-3 py-1 text-gray-600 hover:text-gray-800 text-sm">Cancel</button>
    ...
    console.log('Comment features: Loaded successfully');
    console.log('toggleLike:', typeof window.toggleLike);
    console.log('addReply:', typeof window.addReply);
    console.log('getCommentHTML:', typeof window.getCommentHTML);
});
